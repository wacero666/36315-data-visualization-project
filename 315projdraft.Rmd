...
dend %>% set("labels", countries_of_the_world$Country, order_value = TRUE) %>% 
  set("labels_col", get_colors(countries_of_the_world$Region), order_value = TRUE)  %>% 
  ggplot(horiz = T) + 
  labs(
...
countries_cont <- countries_of_the_world %>% select(Population, Area..sq..mi.., GDP....per.capita., Pop..Density..per.sq..mi.., Coastline..coast.area.ratio., Net.migration, Infant.mortality..per.1000.births., Literacy...., Birthrate, Deathrate)
